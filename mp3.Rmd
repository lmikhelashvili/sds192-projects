...
- `r standard_button("github")`: We mastered the Github standard because we filed minimal working examples as `reprex` Issues and assigned the professor/each other. We resolved a couple of merge conflicts. Cloned repositories, committed, pushed, and pulled.
