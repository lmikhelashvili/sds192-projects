...
marion_context <- tribble(
  ~year_label, ~vpos, ~hjust, ~name, ~text,
  1950, 0.40, "down", "Marion", "Marion Jones wins \ngold in Olympics"
)

marion_segments <- tribble(
  ~year, ~pct_girls, ~name, ~ordered,
  1940, 0.43, "Marion", "2 .  Marion",
  1940, 0.5, "Marion", "2 .  Marion",
  2000, 0.5802469, "Marion", "2 .  Marion"
)

jackie_context <- tribble(
  ~year_label, ~vpos, ~hjust, ~name, ~text,
1965, 0.50, "up", "Jackie", "Jackie Robinson to \nmajor league"
)

jackie_segments <- tribble(
  ~year, ~pct_girls, ~name, ~ordered,
  1940, 0.43, "Jackie", "3 .  Jackie",
  1940, 0.5, "Jackie", "3 .  Jackie",
...
jamie_context <- tribble(
  ~year_label, ~vpos, ~hjust, ~name, ~text,
  1950, 0.35, "left", "Jamie", "Jamie Hunter Cartwright \nappears on Bonanza"
)

jamie_segments <- tribble(
  ~year, ~pct_girls, ~name, ~ordered,
  1940, 0.43, "Jamie", "18 .  Jamie",
  1940, 0.5, "Jamie", "18 .  Jamie",
...
data 
geom_rect(data = x, 
fill = NA, color = "white", size = 1.9, xmin = -Inf, ymin = -Inf, ymax = Inf)
