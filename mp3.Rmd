...
segments_comb <- rbind(jessie_segments,
                       marion_segments,
                       jamie_segments,
                       jackie_segments)
  
segments_data <- uni_order %>%
  full_join(segments_comb, by = c("name" = "name"))
```
